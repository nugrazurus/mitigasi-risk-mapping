...
<thead>
    <tr>
        ...
        <th class="border-2">Risiko</th>
        <th class="border-2">Kemungkinan</th>
        <th class="border-2">Dampak</th>
        <th class="border-2">Nilai Risiko</th>
    </tr>
</thead>
<tbody>
    <tr>
        <td class="border-2"></td>
        <td class="border-2 font-bold text-center">Capaian Kinerja PTN BLU
        </td>
        <td class="border-2"></td>
        <td class="border-2"></td>
        <td class="border-2"></td>
    ...
    <tr>
        ...
        <td class="border-2">Persentase Lulusan Perguruan Tinggi yang Langsung Bekerja</td>
    ...
    <tr>
        <td class="border-2">2</td>
        <td class="border-2">Jumlah Mahasiswa yang berwirausaha</td>
        <td class="border-2">2</td>
        <td class="border-2">2</td>
        <td class="border-2">4</td>
    </tr>
    <tr>
        ...
        <td class="border-2">Persentase Prodi Terakreditasi Unggul</td>
        <td class="border-2">2</td>
    ...
    <tr>
        <td class="border-2">4</td>
        <td class="border-2">Rangking Perguruan Tinggi Nasional</td>
        <td class="border-2">2</td>
        <td class="border-2">4</td>
    ...
    <tr>
        <td class="border-2">5</td>
        <td class="border-2">Persentase Dosen Berkualifikasi Doktor</td>
        <td class="border-2">2</td>
        <td class="border-2">5</td>
        <td class="border-2">10</td>
    </tr>
    <tr>
        ...
        <td class="border-2">Jumlah Publikasi Internasional</td>
        <td class="border-2">2</td>
        <td class="border-2">2</td>
        <td class="border-2">4</td>
    </tr>
    <tr>
        ...
        <td class="border-2">Jumlah Jurnal Bereputasi Terindeks Global</td>
        <td class="border-2">1</td>
        <td class="border-2">5</td>
        <td class="border-2">5</td>
    </tr>
    <tr>
        <td class="border-2">8</td>
        <td class="border-2">Jumlah Kekayaan Intelektual yang Didaftarkan</td>
        <td class="border-2">2</td>
        <td class="border-2">3</td>
        <td class="border-2">6</td>
    </tr>
    <tr>
        ...
        <td class="border-2">Jumlah Prototipe Industri</td>
        <td class="border-2">2</td>
        <td class="border-2">4</td>
        <td class="border-2">8</td>
    </tr>
    <tr>
        <td class="border-2">10</td>
        <td class="border-2">Jumlah Produk Inovasi</td>
        <td class="border-2">2</td>
        <td class="border-2">4</td>
        <td class="border-2">8</td>
    </tr>
    <tr>
        <td class="border-2">11</td>
        <td class="border-2">Jumlah Mahasiswa yang Mengikuti Kegiatan Merdeka Belajar</td>
        <td class="border-2">2</td>
        <td class="border-2">2</td>
        <td class="border-2">4</td>
    </tr>
    <tr>
        ...
        <td class="border-2">Jumlah Prodi yang Menerapkan Pembelajaran Kampus Merdeka</td>
        <td class="border-2">2</td>
        <td class="border-2">2</td>
        <td class="border-2">4</td>
    </tr>
